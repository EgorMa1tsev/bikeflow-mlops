...
- веб-интерфейс: прогноз в форме, журнал с флагами аномалий, проверка дрейфа, кнопка переобучения
...
| Мониторинг и переобучение | проверка дрейфа, отчёт Evidently, кнопка переобучения и итог quality gate |
